...
* [church-calendar-api](https://github.com/igneus/church-calendar-api) ⭐ 137 | 🐛 12 | 🌐 Ruby | 📅 2024-04-01 - RESTful API providing Roman Catholic church calendar data for your apps.
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 102 | 🐛 35 | 🌐 PHP | 📅 2026-09-10 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [romcal](https://github.com/romcal/romcal) ⭐ 137 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-12 - The Liturgical Calendar used by the Roman Rite (Western Church) for Node JS v6 and above.
...
* [divinum-officium](https://github.com/DivinumOfficium/divinum-officium) ⭐ 468 | 🐛 0 | 🌐 HTML | 📅 2026-09-11 - The traditional divine office.
