...
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 99 | 🐛 34 | 🌐 PHP | 📅 2026-08-12 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [catholicism-in-json](https://github.com/aseemsavio/catholicism-in-json) ⭐ 33 | 🐛 3 | 🌐 Python | 📅 2022-09-24 - The Catechism of the Catholic Church, The Canon Law, and The General Instruction of The Roman Missal in usable JSON format.
...
* [Catholic Lectionary on ESP8266](https://github.com/plishman/Catholic-Lectionary-on-ESP8266) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2026-06-10 - The Roman Catholic Lectionary, Liturgical Calendar and Feast Days on ESP8266 with Waveshare 2.7" or 4.2" red/black display, generic SD card reader and DS3231 clock IC.
