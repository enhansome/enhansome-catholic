...
* [liturgia-diaria](https://github.com/Dancrf/liturgia-diaria) ⭐ 210 | 🐛 6 | 📅 2026-04-24 - An API for the daily readings in Portuguese.
...
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 100 | 🐛 35 | 🌐 PHP | 📅 2026-08-17 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
* [Biblia-Sacra-Vulgata](https://github.com/aseemsavio/Biblia-Sacra-Vulgata) ⭐ 18 | 🐛 1 | 🌐 Kotlin | 📅 2021-11-21 - Biblia Sacra Vulgata is a RESTful API project primarily serving the Original Latin Vulgate ( ✝️ Biblia Sacra Vulgata) and its English Translation - Catholic Public Domain Version (CPDV) with study notes.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [gregorio](https://github.com/gregorio-project/gregorio) ⭐ 214 | 🐛 101 | 🌐 C | 📅 2026-08-03 - Software application for engraving Gregorian Chant scores on a computer.
...
* [vul](https://github.com/LukeSmithxyz/vul) ⭐ 136 | 🐛 1 | 🌐 Awk | 📅 2023-03-14 - Latin Vulgate Bible on the Command Line.
...
* [vul-dra](https://github.com/RaynardGerraldo/vul-dra/) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2023-04-14 - Side by side translation of the Latin Vulgate and the Douay Rheims bible.
...
* [romcal](https://github.com/romcal/romcal) ⭐ 137 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-15 - The Liturgical Calendar used by the Roman Rite (Western Church) for Node JS v6 and above.
* [AquinasOperaOmnia](https://github.com/Geremia/AquinasOperaOmnia) ⭐ 90 | 🐛 0 | 🌐 HTML | 📅 2026-04-19 - The full works of St. Thomas Aquinas.
* [catechism-ccc-json](https://github.com/nossbigg/catechism-ccc-json) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2022-12-08 - The Catechism of the Catholic Chruch in JSON.
...
* [vulgata](https://github.com/borderstech/vulgata) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2020-08-18 - The Holy Bible with both the Douay-Rheims English and Clementina Vulgata Latin texts.
...
* [cardinals](https://github.com/ChrisVo/cardinals) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - The list of all Roman Catholic Cardinals in json format.
...
* [Catholic Lectionary on ESP8266](https://github.com/plishman/Catholic-Lectionary-on-ESP8266) ⭐ 13 | 🐛 0 | 🌐 C | 📅 2026-06-10 - The Roman Catholic Lectionary, Liturgical Calendar and Feast Days on ESP8266 with Waveshare 2.7" or 4.2" red/black display, generic SD card reader and DS3231 clock IC.
...
* [Mariam](https://github.com/aldrinzigmundv/mariam) ⭐ 4 | 🐛 1 | 🌐 Dart | 📅 2024-09-02 - Meditative rosary app that enables believers to pray the Rosary.
...
* [Lectio.nvim](https://github.com/ngorden/lectio.nvim) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2024-11-19 - Neovim plugin to practice lectio divina.

## Web-Apps

* [divinum-officium](https://github.com/DivinumOfficium/divinum-officium) ⭐ 458 | 🐛 1 | 🌐 HTML | 📅 2026-08-17 - The traditional divine office.
...
* [Missale Meum](https://github.com/mmolenda/missalemeum) ⭐ 119 | 🐛 10 | 🌐 Python | 📅 2026-08-17 - 1962 Roman Catholic Missal for the Traditional Latin Mass.
...
* [Citation Generator](https://github.com/matefs/Citation-Generator) ⭐ 4 | 🐛 0 | 🌐 CSS | 📅 2023-01-21 - Create quotes from Saints, the Bible or any based author.
* [Ember Days](https://github.com/saint-isidore-guild/ember-days) ⭐ 4 | 🐛 18 | 🌐 JavaScript | 📅 2023-02-20 - Display the Ember Days for a given year.
* [Oficjum](https://github.com/anna-wro/rkk) ⭐ 4 | 🐛 20 | 🌐 MDX | 📅 2026-03-06 - A Progressive Web App that provides daily liturgical texts for the Liturgy of the Hours in Polish. Demo at <https://oficjum.starokatolicy.eu/>.
* [catholic-bible-cheatsheet](https://github.com/nonnobisdomine62/catholic-bible-cheatsheet) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-25 - Digital reference for the Catholic Bible Cheatsheet from Dr. Taylor Marshall with Bible verses.
* [TradCatholicQuotes](https://github.com/nonnobisdomine62/tradcathquotes) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2025-07-04 - Traditional Catholic quote collection about the fewness of the saved, the rosary, and the use of Latin.
* [Rezo de los Mil Jesús](https://github.com/emamut/rezo-mil-jesus) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2025-04-12 - Web application to assist in the devotion of Los Mil Jesús.
* [St Michael Chaplet](https://github.com/port19x/StMichaelChaplet) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2025-06-16 - Chaplet of Saint Michael the Archangel.
* [Code of Canon Law](https://github.com/shineministry/codeofcanonlaw) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2025-06-15 - The Code of Canon Law, with searching capability.
* [auxilium-christianorum](https://github.com/nonnobisdomine62/auxilium-christianorum-frontend) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-26 - Unofficial frontend for the daily Auxilium Christianorum prayers for the laity.
* [doctors of the church](https://github.com/masaharumori7/doctors-of-the-church) ⭐ 0 | 🐛 0 | 🌐 CSS | 📅 2025-07-31 - A gallary list of all 37 Doctors of the Church with descriptions and notable works.
* [Index Librorum Prohibitorum](https://github.com/leozamboni/index-librorum-prohibitorum) ⭐ 0 | 🐛 1 | 🌐 HTML | 📅 2026-06-14 - Site to consult the Index Librorum Prohibitorum, books a Catholic should read with caution. Demo at <https://leozamboni.github.io/index-librorum-prohibitorum/>.
...
* [Awesome Theology](https://github.com/historical-theology/awesome-theology) ⭐ 70 | 🐛 0 | 📅 2020-12-13 - A curated list of open source software for Catholic theology.
* [Awesome Church Calendar](https://github.com/calendarium-romanum/awesome-church-calendar) ⭐ 30 | 🐛 3 | 📅 2022-10-11 - List of software related to liturgical calendar computations.
* [Awesome Bible](https://github.com/awesome-bible/awesome-bible.github.io) ⭐ 15 | 🐛 1 | 📅 2018-09-26 - A curated list of awesome resources and websites about the Bible and topics related to it.
