...
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 102 | 🐛 29 | 🌐 PHP | 📅 2026-08-29 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [romcal](https://github.com/romcal/romcal) ⭐ 138 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-29 - The Liturgical Calendar used by the Roman Rite (Western Church) for Node JS v6 and above.
...
* [divinum-officium](https://github.com/DivinumOfficium/divinum-officium) ⭐ 463 | 🐛 0 | 🌐 HTML | 📅 2026-08-29 - The traditional divine office.
