...
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 99 | 🐛 32 | 🌐 PHP | 📅 2026-08-14 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [romcal](https://github.com/romcal/romcal) ⭐ 136 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-15 - The Liturgical Calendar used by the Roman Rite (Western Church) for Node JS v6 and above.
...
* [divinum-officium](https://github.com/DivinumOfficium/divinum-officium) ⭐ 457 | 🐛 1 | 🌐 HTML | 📅 2026-08-15 - The traditional divine office.
