...
* [Liturgical Calendar](https://github.com/Liturgical-Calendar/LiturgicalCalendarAPI) ⭐ 100 | 🐛 33 | 🌐 PHP | 📅 2026-08-20 - A PHP script that will generate the liturgical calendar for any given year, based on the General Roman Calendar, calculating the mobile festivities and the precedence of solemnities, feasts, and memorials.
...
* [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - API for Daily Catholic gospel reflections in German, English, and Polish, generated via GitHub Actions and Magisterium AI.
...
* [gregorio](https://github.com/gregorio-project/gregorio) ⭐ 215 | 🐛 103 | 🌐 C | 📅 2026-08-03 - Software application for engraving Gregorian Chant scores on a computer.
...
* [vul](https://github.com/LukeSmithxyz/vul) ⭐ 137 | 🐛 1 | 🌐 Awk | 📅 2023-03-14 - Latin Vulgate Bible on the Command Line.
...
* [romcal](https://github.com/romcal/romcal) ⭐ 138 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-15 - The Liturgical Calendar used by the Roman Rite (Western Church) for Node JS v6 and above.
...
* [divinum-officium](https://github.com/DivinumOfficium/divinum-officium) ⭐ 461 | 🐛 0 | 🌐 HTML | 📅 2026-08-20 - The traditional divine office.
